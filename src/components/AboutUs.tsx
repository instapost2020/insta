...
const AboutUs = () => {
  return (
    <div>
      <div className="bg-yellow-400 relative   flex items-center  n justify-center overflow-hidden z-10 ">
        <div className="relative mx-auto h-full px-4  pb-20   md:pb-10 sm:max-w-xl md:max-w-full md:px-24 lg:max-w-screen-xl lg:px-8">
          <div className="flex flex-col items-center justify-between lg:flex-row py-16">
            <div className=" relative ">
              <div
                className={`${raleway.className} lg:max-w-xl lg:pr-5 relative z-40`}
              >
                <p className="flex text-sm uppercase  ">Hello!</p>
            ...
            <div className="relative hidden lg:ml-32 lg:block lg:w-1/2">
              <svg
                ...
                className="my-6 mx-auto h-10 w-10 animate-bounce rounded-full p-2 lg:hidden"
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
                strokeWidth="2"
              ...
              <div className="abg-orange-400 relative mx-auto w-[500px] h-[400px] overflow-hidden rounded-[6rem] rounded-br-none rounded-tl-none">
                <Image
                  src={"/newoffice.png"}
                  fill
                  alt="New Office"
